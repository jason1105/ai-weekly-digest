...
3. It calls **Claude** (`claude-haiku-4-5-20251001`) to pick the 10 most interesting items and write a Chinese summary for each.
...
- **Model** — swap `claude-haiku-4-5-20251001` for any Anthropic model you prefer.
